...
// Update DOM with JSON data (weather)
const updateDOM = (data) => {
  ...
  switch (data.current_weather.weathercode) {
    ...
    case 3:
      currentWeatherIcon.setAttribute(
        "src",
        isDay ? "./icons/weather/cloud.png" : "./icons/weather/cloud-moon.png"
      );
      break;
    case 45:
    case 48:
...
if (localStorage.getItem("test") === "true") {
  ...
  if (
    ...
    console.log("No previous weather data found");
  } else {
    updateDOM(JSON.parse(localStorage.getItem("weather")));
  }
}
    ...
    fetch(
      ...
      .then((data) => {
        ...
        for (let searchResult of resultsList) {
          admin3 =
            searchResult.admin3 === undefined ? "" : searchResult.admin3 + ", ";
          admin2 =
            searchResult.admin2 === undefined ? "" : searchResult.admin2 + ", ";
          admin1 =
            searchResult.admin1 === undefined ? "" : searchResult.admin1 + ", ";
          resultStack += `<div class="drop-down-item" lat="${searchResult.latitude}" long="${searchResult.longitude}">
                    ${admin3}${admin2}${admin1}${searchResult.country}
                    </div>`;
        }
